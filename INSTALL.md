...
1. install mysql
2. create metadata table in mysql
mysql -h<ip> -P<port> -p<password> -u<user> < docs/metadata.sql
...
* install chunkserver
1. submit chunkserver info to chunkmaster
vim serverlist.json     
[     
...
2. start chunkserver process group according above setting
...
maybe need to install python-pip, python-devel or liblzma
